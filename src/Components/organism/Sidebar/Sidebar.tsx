...
import avatarImg from "../../../assets/images/boy_avatar_icon_148455.png";
    ...
    <SidebarStyle>
      <nav className="sidebar">
        ...
        <div className="sidebar-menu_container">
          <div className={`sidebar-menu ${location.pathname === '/' ? 'active' : ''}`}>
            <NavLink to={"/"}>
          ...
          <div className={`sidebar-menu ${location.pathname === '/search' ? 'active' : ''}`}>
            <NavLink to={"/search"}>
              <div className="sidebar-menu__item">
          ...
          <div className={`sidebar-menu ${location.pathname === '/favourites' ? 'active' : ''}`}>
            <NavLink to={"/"}>
              <div className="sidebar-menu__item">
                <IoMdHeart size={16} />
          ...
          <div className={`sidebar-menu ${location.pathname === '/playlists' ? 'active' : ''}`}>
            <NavLink to={"/"}>
              <div className="sidebar-menu__item">
          ...
          <div className={`sidebar-menu ${location.pathname === '/charts' ? 'active' : ''}`}>
            <NavLink to={"/"}>
              <div className="sidebar-menu__item">
